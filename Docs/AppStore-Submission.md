...
- Release candidate: version `1.0`, build `17`
...
- Current in-repo product media lives in `Docs/Media/AppStoreReady/6.9-inch`, `Docs/Media/AppStoreReady/13-inch`, and `Docs/Media/AppStoreReady/tvOS`; only upload screenshots that match the current UI and device family
